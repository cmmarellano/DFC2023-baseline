...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/roof_fine_train_merge.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'image_id/image_id_val.json', #'annotations/roof_fine_val_merge.json',
...
#original:  ann_file=data_root + 'annotations/roof_fine_train_merge.json'
